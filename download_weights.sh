...
curl https://pjreddie.com/media/files/yolov3.weights -o implementations/yolov3/weights
curl https://pjreddie.com/media/files/darknet53.conv.74 -o implementations/yolov3/weights
